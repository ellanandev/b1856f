  ...
  switch (action.type) {
    case GET_CONVERSATIONS:
      return action.conversations.map(conversation => ({
        ...conversation,
        messages: conversation.messages.slice().sort((a, b) => new Date(a.createdAt) - new Date(b.createdAt)),
      }));
    case SET_MESSAGE:
    ...
    case SET_MESSAGE_READ:
      return setMessageReadInStore(state, action.payload);
    default:
      return state;
  }
};
